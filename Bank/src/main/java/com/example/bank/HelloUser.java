...
public class HelloUser {
    ...
    @FXML
    private Button  cancbtn, checkbtn,transbtn;
    @FXML
    BorderPane border1;
    private Stage stage;
    @FXML
   TableView table;
    ...
    public void checkTrans(ActionEvent e) {
        ...
        table.setEditable(true);
        table.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
        table.getColumns().addAll(tnumber, anumber, date, mOfTransaction, tType, tAmount);
        table.setVisible(true);
        fullName.setVisible(true);
        ...
        try (Connection connection = connectnow.connectToDatabase();
            ...
            while (resultSet1.next()) {
                ...
                data.add(new TransactionDataModel(transNumber,Account,dot,mTransaction,
